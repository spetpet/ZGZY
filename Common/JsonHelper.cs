...
namespace ZGZY.Common
{
    ...
    public class JsonHelper
    {
        ...
        #region stringlist转json
        public static string StringArrayToJson(string[] str)
        {
            ...
            jsonString.Append("[\"");
                ...
                for (int i = 0; i < str.Length; i++)
                {
                    ...
                    if (i < str.Length - 1)
                        jsonString.Append(str[i].ToString() + "\",\"");
                    else
                        jsonString.Append(str[i].ToString());
                }
                jsonString.Append("\"]");
        ...
        #region stringlist转json数字
        public static string StringArrayToJsonInt(string[] str)
        {
            StringBuilder jsonString = new StringBuilder();
            jsonString.Append("[");
        ...
        public static string ColumnToJson(DataTable dt, int r)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                strSql.Append(dt.Rows[i][r].ToString().Trim());
                strSql.Append(",");
            }
        ...
        /// Datatable转换为Json     
        /// </summary>    
        public static string ToJsonLower(DataTable dt)
        {
            if (dt.Rows.Count > 0)
            {
                StringBuilder jsonString = new StringBuilder();
        ...
        /// DataTable转换为Json(小写)
        /// </summary>    
        public static string ToJsonLower(DataTable dt, string jsonName)
        {
            StringBuilder Json = new StringBuilder();
            if (string.IsNullOrEmpty(jsonName))
                jsonName = dt.TableName;
