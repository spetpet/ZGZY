...
namespace ZGZY.SQLServerDAL
{
    ...
    public class User : ZGZY.IDAL.IUser
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public DataTable GetUserByClassId(int id)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("select u.Id Id,u.UserId UserId,u.UserName UserName,uc.classid ClassId,uc.score Score from tbUserClass uc");
            sb.Append(" join tbUser u on u.Id=uc.UserId");
            sb.Append(" where uc.ClassId=@Id");
        ...
        public int AddUser(Model.User user)
        {
            ...
            strSql.Append("insert into tbUser(UserId,UserName,UserPwd,IsAble,IfChangePwd,Description,birthday,indate,title,sex)");
            strSql.Append(" values ");
            strSql.Append("(@UserId,@UserName,@UserPwd,@IsAble,@IfChangePwd,@Description,@birthday,@indate,@title,@sex)");
            ...
            SqlParameter[] paras = { 
                                   ...
                                   new SqlParameter("@indate",user.indate),
        ...
        public bool EditUser(Model.User user)
        {
            ...
            strSql.Append("UserId=@UserId,UserName=@UserName,IsAble=@IsAble,IfChangePwd=@IfChangePwd,Description=@Description,birthday=@birthday,indate=@indate,title=@title,sex=@sex");
