...
namespace ZGZY.DALFactory
{
    ...
    public class Factory
    {
        ...
        public static ZGZY.IDAL.IClass GetClassDAL()
        {
            ZGZY.IDAL.IClass Classes = GetInstance("Class") as ZGZY.IDAL.IClass;
            return Classes;
        
        }

        public static ZGZY.IDAL.IUserClass GetUserClassDAL()
        {
            ZGZY.IDAL.IUserClass userClass = GetInstance("UserClass") as ZGZY.IDAL.IUserClass;
            return userClass;
        }
